...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form:form action="update.from" method="post" cssClass="main_form" commandName="cost">
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info"><form:input cssClass="readonly" readonly="true" path="id"/></div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <form:input cssClass="width300" path="name"/>
                    <span class="required">*</span>
                    <div class="validate_msg_short">50长度的字母、数字、汉字和下划线的组合</div>
                </div>
                <div class="text_info clearfix"><span>资费类型：</span></div>
                <div class="input_info fee_type">
                    <form:radiobutton path="cost_type" value="1" label="包月" id="monthly" onclick="feeTypeChange(1);" ></form:radiobutton>
                    
                    <form:radiobutton path="cost_type" value="2" label="套餐" id="package" onclick="feeTypeChange(2);" ></form:radiobutton>
                   
                    <form:radiobutton path="cost_type" value="3" label="计时" id="timeBased" onclick="feeTypeChange(3);"></form:radiobutton>
                ...
                <div class="input_info_high">
                    <form:textarea cssClass="width300 height70" path="descr"></form:textarea>
